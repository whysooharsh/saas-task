      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-16 py-8">
        <div className="w-full max-w-md" style={{ maxWidth: '400px' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between" style={{ paddingTop: '8px', paddingBottom: '8px' }}>
              <label className="flex items-center cursor-pointer">
                <input type="checkbox" className="mr-2" style={{ accentColor: '#8054FF' }} />
                <span style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', color: '#9E9E9E' }}>Remember me</span>
              </label>
              <Link href="#" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', color: '#8054FF' }}>
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            >
              ...
              <div className="text-left">
                <div style={{ fontSize: '10px', color: '#9E9E9E' }}>Login with</div>
          ...
          <p className="mt-8" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', color: '#9E9E9E' }}>
            ...
            <Link href="/signup" style={{ color: '#8054FF', fontWeight: 500 }}>
              Sign Up
            </Link>
          </p>
        </div>
